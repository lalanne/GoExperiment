...
func NewHello_PortType(url string, tls bool, auth *BasicAuth) *Hello_PortType {
	if url == "" {
		url = ""
	}
...
func NewHello_PortTypeWithTLSConfig(url string, tlsCfg *tls.Config, auth *BasicAuth) *Hello_PortType {
	if url == "" {
		url = ""
	}
...
func (service *Hello_PortType) AddHeader(header interface{}) {
	service.client.AddHeader(header)
}

// Backwards-compatible function: use AddHeader instead
func (service *Hello_PortType) SetHeader(header interface{}) {
	service.client.AddHeader(header)
}

func (service *Hello_PortType) SayHello(request *String) (*String, error) {
	response := new(String)
	err := service.client.Call("sayHello", request, response)
	if err != nil {
		return nil, err
	}
